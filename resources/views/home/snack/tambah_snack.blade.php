...
<form method="POST" action="{{ url('/save_tambah_quantity_snack')}}">
    @csrf
    <div class="modal-header">
        <h5 class="modal-title" id="modalSayaLabel">Tambahkan Quantity Snack</h5>
    ...
    <div class="modal-body">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control  @error ('jumlah_masuk') is-invalid @enderror" id="jumlah_masuk"
                placeholder="Masuk Kuantiti" name="jumlah_masuk" value="{{$item->jumlah_masuk}}"> @error('harga_jual')
            <div class="invalid-feedback">
                {{$message}}
            </div>
            @enderror
